...
ActiveRecord::Schema.define(version: 2019_10_29_024431) do
  ...
  create_table "physicians", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["appointments_id"], name: "index_physicians_on_appointments_id"
  end

  add_foreign_key "offices", "physicians"
  add_foreign_key "patients", "appointments"
  add_foreign_key "physicians", "appointments", column: "appointments_id"
end
